...
if($_SESSION['status']==1){
    ...
    $status='<b class="text-primary">Not Voted</b>';
}
        ...
        <div class="row my-5">
            <div class="col-md-7">
                ...
                if(isset($_SESSION['candidates'])){
                    ...
                    // echo $candidates[0]['votes'];
                    for($i=0;$i<count($candidates);$i++){
                        ?>
                        <div class="row">
                        <div class="col-md-4">
                            <img src="<?php echo $candidates[$i]['photo'] ?>" alt="Candidate <?php echo $i+1 ?> image">
                        </div>
                        <div class="col-md-8">
            ...
            <div class="col-md-5">
                <!-- voters -->
                <img src="<?php echo $data['photo']?>" alt="Voter image">
                <br>
                <br>
